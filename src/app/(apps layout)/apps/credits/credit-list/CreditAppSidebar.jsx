            ...
            <SimpleBar className="nicescroll-bar">
                <div className="menu-content-wrap">
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item as={Link} href="/apps/credits/credit-request" >Nueva Solicitud</Dropdown.Item>
                        ...
                        <Nav as="ul" className="nav-light navbar-nav flex-column">
                            ...
                            <Nav.Item as="li">
                                <Nav.Link>
                                    ...
                                    <span className="nav-link-text">Enviados</span>
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                                <Nav.Link>
                            ...
                            <Nav.Item as="li">
                                <Nav.Link>
                                    ...
                                    <span className="nav-link-text">Pendientes</span>
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                                <Nav.Link>
                                    ...
                                    <span className="nav-link-text">Eliminados</span>
                                </Nav.Link>
                            </Nav.Item>
                        </Nav>
                    </div>
                        ...
                        <Nav as="ul" className="nav-light navbar-nav flex-column">
                            <Nav.Item as="li" >
                                <Nav.Link>
                                    ...
                                    <span className="nav-link-text">Manage Créditos</span>
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li" >
                                <Nav.Link>
                                    ...
                                    <span className="nav-link-text">Recurring Créditos</span>
                                </Nav.Link>
                            </Nav.Item>
                            <Nav.Item as="li" >
                                <Nav.Link>
